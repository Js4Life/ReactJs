...
import com.parabole.feed.platform.assimilation.ColumnReference;
import com.parabole.feed.platform.assimilation.ViewColumn;
import com.parabole.feed.platform.assimilation.ViewQueryRequest;
...
public class Biota extends GraphDb {
    ...
    public Biota() {
        final String graphDbUrl = AppUtils.getApplicationProperty(CCAppConstants.INDUSTRY + ".biota.graphdb.url");
        final String graphDbUser = AppUtils.getApplicationProperty(CCAppConstants.INDUSTRY + ".biota.graphdb.user");
        final String graphDbPassword = AppUtils.getApplicationProperty(CCAppConstants.INDUSTRY + ".biota.graphdb.password");
        final Integer graphDbPoolMinSize = AppUtils.getApplicationPropertyAsInteger(CCAppConstants.INDUSTRY + ".biota.graphdb.pool.min");
        final Integer graphDbPoolMaxSize = AppUtils.getApplicationPropertyAsInteger(CCAppConstants.INDUSTRY + ".biota.graphdb.pool.max");

...
/**
 * Assimilators Disperser
 * This will remove dynamic graph data into a single graph!
 * 
 * @author Sagiruddin Mondal
 * @since v1.0
 */

public class AssimilatorDisperser {
	
	
	JSONArray combinedVertices;
	JSONArray combinedEdges;

	public AssimilatorDisperser(JSONObject inputGraph){
		this.combinedVertices= new JSONArray();
		this.combinedEdges=new JSONArray();
		compose(inputGraph);	
	}
	
	public AssimilatorDisperser compose(JSONObject newGraph){

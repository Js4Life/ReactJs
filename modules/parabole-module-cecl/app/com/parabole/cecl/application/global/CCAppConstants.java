package com.parabole.cecl.application.global;
...
public class CCAppConstants extends AppConstants {
    ...
    public static final String JENA_FILTERDEF_FILE = "filterMetadata_cecl.json";
    ...
    public static enum ConfigurationType {
        NODEMAP, REPORT, AGGREGATION, ADMINDATA, DATASOURCE, EXCEL_METADATA, AGGREGATEMAPPING, DBVIEW, LOGICAL_VIEW_ONE, BASENODE_CFG, DATANODE_CFG, COMBINED_VIEW, IMPACT_GRAPH_IMAGE, COMPOSITEAGGREGATION, DOCUMENT_PARSED_JSON, ACCOUNTING_DOCUMENT
    }
    ...
    public static enum DocumentName {
        FASBAccntStandards
    }
}

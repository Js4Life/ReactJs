...
/***/ function(module, exports, __webpack_require__) {
  ...
  function Network (container, data, options) {
    ...
    this.defaultOptions = {
      ...
      edges: {
        hideEdgeLabel: options.hideEdgeLabel || false,
...
/***/ function(module, exports, __webpack_require__) {
  ...
  Edge.prototype._drawDashLine = function(ctx) {
    ...
    // draw label
    if (this.label && !this.network.defaultOptions.edges.hideEdgeLabel) {
      var point;
      if (this.options.smoothCurves.enabled == true && via != null) {
        var midpointX = 0.5*(0.5*(this.from.x + via.x) + 0.5*(this.to.x + via.x));
        var midpointY = 0.5*(0.5*(this.from.y + via.y) + 0.5*(this.to.y + via.y));
    ...
    if (this.from != this.to) {
      ...
      if (this.label && !this.network.defaultOptions.edges.hideEdgeLabel) {
        ...
        if (this.options.smoothCurves.enabled == true && via != null) {
          //var midpointX = 0.5*(0.5*(this.from.x + via.x) + 0.5*(this.to.x + via.x));
          //var midpointY = 0.5*(0.5*(this.from.y + via.y) + 0.5*(this.to.y + via.y));
          var midpointX =  ( xFrom + xTo )/2;
          var midpointY =  ( yFrom + yTo )/2;
          point = {x:midpointX, y:midpointY};
        }
        else {
          point = this._pointOnLine(0.5);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  Node.prototype._drawImage = function (ctx) {
    ...
    if (this.imageObj.width != 0 ) {
      // draw the shade
      if (this.clusterSize > 1 || this.included) {
  ...
  Node.prototype._label = function (ctx, text, x, y, align, baseline, labelUnderNode) {
    if (text && Number(this.options.fontSize) * this.networkScale > this.fontDrawThreshold) {
      ...
      var fSize = this.options.fontSize;
      if( this.included )
    	  fSize += 1;
      ctx.font = (this.selected || this.included ? "bold " : "") + fSize + "px " + this.options.fontFace;
      if( this.included ){
    	  ctx.fillStyle = "green";
      }
      else

...
// =============================================================================
package com.parabole.platform.authorizations.securities;
...
/*    static {
    ...
    public boolean authenticate(final String username, final String password) {
        ...
        try {
            final String storedPassword = coralUserService.getSpecificDocumentUsingIdAndColumnName(username, AuthConstants.ATTR_DATABASE_PASSWORD_COLUMN_NAME);

...
import com.parabole.ccar.platform.assimilation.*;
import com.parabole.ccar.platform.exceptions.AppException;
import com.parabole.ccar.platform.graphdb.Biota;
import com.parabole.ccar.platform.AppConstants;
import com.parabole.ccar.platform.graphdb.GraphDbLinkDefinition;
...
public class BiotaServices {
    ...
    public void createView(final JSONObject viewJson) throws AppException {
        final JSONArray columnsJson = viewJson.getJSONArray(CCAppConstants.ATTR_VIEWCREATION_COLS);
        final String viewName = viewJson.getString(CCAppConstants.ATTR_DATASOURCE_MAPPING_NAME);
        final List<String> colNames = new ArrayList<String>();
        final int colCount = columnsJson.length();
        for (int i = 0; i < colCount; i++) {
            final JSONObject aColumn = columnsJson.getJSONObject(i);
            colNames.add(aColumn.getString(CCAppConstants.ATTR_DATASOURCE_MAPPING_NAME));
        }
    ...
    public JSONObject getDataFromLogicalView(final String userId, final ViewQueryRequest viewQuery) throws AppException {
        ...
        retObj.put(CCAppConstants.ATTR_VIEWCREATION_COLS, cols);
        retObj.put(CCAppConstants.ATTR_VIEWCREATION_DATA, jsonArr);
        return retObj;
    }
    ...
    public JSONObject showAggregatedView(final String userId, final JSONObject jsonObj) throws AppException {
        ...
        final String joinAttr = joinObj.getString(CCAppConstants.ATTR_DATASOURCE_MAPPING_NAME);

...
public class CCAppConstants extends AppConstants {
	...
	public static final Set<String> RDA_RELATIONSHIPS = AppUtils
			.createSetFromApplicationProperty(INDUSTRY + ".relationships.filter", "|");
	...
	public static final String CONF_FILE_PATH = "files/";
